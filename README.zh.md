![dsh-cool-theme cover](https://cdn.cooltea.top/dsh-cool-theme/readme-cover-v0.6.0.png)
...
DeepSeek Harness 主题插件 —— 支持「深色」「浅色」「跟随系统」外观切换，提供 34 款预设主题，支持创建/分享/导入自定义主题。
...
4. **主题分享：** 分享自己创建的自定义主题，或者导入他人分享的自定义主题。
