window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const bluish$13 = buildScale("--dsw-static-neutral-bluish", "#EDE9FE", "#15141B", BLUISH_STEPS);
		const neutral$13 = buildScale("--dsw-static-neutral", "#EDE9FE", "#15141B", NEUTRAL_STEPS);
