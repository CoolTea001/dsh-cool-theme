		...
		function ThemePanel(props) {
			...
			*/
			...
			react.useEffect(() => {
				...
				function onClick(e) {
					if (!dirtyRef.current || confirmCloseRef.current || confirmLeaveRef.current || pendingDeleteRef.current) return;
			...
			*/
			...
			if (confirmLeave && editing) children.push(react.createElement(ConfirmDialog, {
				key: "confirm-leave",
				title: t("custom.unsaved.title"),
