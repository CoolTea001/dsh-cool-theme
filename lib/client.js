		...
		*/
		function ThemeCard(props) {
			...
			return react.createElement("div", {
				...
				onClick: (e) => e.stopPropagation()
			}, active ? react.createElement("span", { className: "ct-list-badge" }, t("custom.inUse")) : null, action(t("custom.edit"), onEdit), action(t("custom.delete"), onDelete, true)));
		}
		/**
			...
			*/
			...
			react.useEffect(() => {
				...
				function onClick(e) {
					...
					if (!(!!panel && !panel.contains(target)) && !isCloseButton(target)) return;
					e.preventDefault();
					e.stopPropagation();
					setConfirmClose(true);
				}
