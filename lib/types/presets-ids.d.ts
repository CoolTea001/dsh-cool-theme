 ...
 * them.
 */
export declare const PRESET_IDS: readonly ["aura", "ayu", "catppuccin", "catppuccin-frappe", "catppuccin-macchiato", "cobalt2", "cursor", "dracula", "dsh", "everforest", "flexoki", "github", "gruvbox", "kanagawa", "lucent-orng", "material", "matrix", "mercury", "monokai", "nightowl", "nord", "onedark", "opencode", "orng", "osaka-jade", "palenight", "rosepine", "solarized", "synthwave84", "system", "tokyonight", "vercel", "vesper", "zenburn"];
 ...
 */
export declare function isKnownBase(value: string): boolean;
//# sourceMappingURL=presets-ids.d.ts.map